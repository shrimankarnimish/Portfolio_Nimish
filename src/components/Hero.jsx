        ...
        <div className="flex flex-wrap">
            <div className="w-full lg:w-1/2">
                <div className="flex flex-col items-center lg:items-start">
                    <motion.h1
                        variants={conatiner(0)}
                        initial="hidden"
                        animate="visible"
                        className="pb-16 txt-6xl font-thin tracking-tight lg:mt-16 lg:text-7xl">Nimish Shrimankar
                    </motion.h1>
                    <motion.span
            ...
            tracking-tight text-transparent">Full Stack Developer
                    </motion.span>
                    <motion.p
